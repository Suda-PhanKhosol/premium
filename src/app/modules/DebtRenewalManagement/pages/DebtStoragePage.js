...
export default function DebtStoragePage() {
    ...
    const handleChange = (event, newValue) => {
      ...
      dispatch(debtRenewalRedux.actions.updateIndexTab(newValue));
    };
    ...
    return (
        <div className={classes.root} style={{ marginLeft:20}}>
              <Grid container>
                  <Grid item > <Typography style={{fontSize:20 }}>ขึ้นจัดเก็บ</Typography></Grid>
              </Grid>
              <br/>
              ...
              <Paper elevation={1} square>
                <br/>
                    ...
                    <TabPanel value={value} index={0}>
                          <DebtRenewalTable moduleName="DebtStorage"></DebtRenewalTable>
                    </TabPanel>
                    <TabPanel value={value} index={1}>
                          <DebtRenewalSuccessTable moduleName="DebtStorage"></DebtRenewalSuccessTable>
                    </TabPanel>
                    <TabPanel value={value} index={2}>
                          <DebtRenewalCancleTable moduleName="DebtStorage"></DebtRenewalCancleTable>
                    </TabPanel>
                    <TabPanel value={value} index={3}>
                          <DebtRenewalAllTable moduleName="DebtStorage"></DebtRenewalAllTable>
                    </TabPanel>
              </Paper>
