...
export default function DebtRenewalPage() {
    ...
    return (
        <div className={classes.root} style={{ marginLeft:20}}>
              <Grid container>
                  <Grid item > <Typography style={{fontSize:20 }}> จัดรายการตั้งหนี้ต่ออายุ (รายปี/ราย 3 ปี)</Typography></Grid>
              </Grid>
              <br/>
              ...
              <Paper elevation={1} square>
                <br/>
                    ...
                    <TabPanel value={value} index={0}>
                          <DebtRenewalTable  moduleName="DebtRenewal"></DebtRenewalTable>
                    </TabPanel>
                    <TabPanel value={value} index={1}>
                          <DebtRenewalSuccessTable  moduleName="DebtRenewal"></DebtRenewalSuccessTable>
                    </TabPanel>
                    <TabPanel value={value} index={2}>
                          <DebtRenewalCancleTable  moduleName="DebtRenewal"></DebtRenewalCancleTable>
                    </TabPanel>
                    <TabPanel value={value} index={3}>
                          <DebtRenewalAllTable moduleName="DebtRenewal"></DebtRenewalAllTable>
                    </TabPanel>
              </Paper>
      </div>
    )
