...
export default function AdvanceSeachAll() {

    const [state] = React.useState({
        endDate: dayjs().startOf('day'),
        paidDate: dayjs().startOf('day'),
      });
    ...
    const handleRemark = (event , newRemarks) => {
    ...
    return (
        <div>
            ...
            >
                <Grid item xs={2} sm={2} md={2} lg={2} >
                    <Typography className={classes.textTiltla}>สาเหตุ</Typography>
                </Grid>
                <Grid item xs={4} sm={4} md={3} lg={3} >
                            <ToggleButtonGroup value={remarks} onChange={handleRemark}  size="small"  style={{borderBlockColor:'#5191D0'}}>
                                <ToggleButton value="expire"  style={{width:150 }}>
                                        <Typography className={classes.textLabel}>เกินกำหนดชำระ</Typography>
                                </ToggleButton>
                                <ToggleButton value="changApp" style={{width:150 }}>
                                        <Typography className={classes.textLabel}>เปลี่ยนกรมธรรม์</Typography>
                                </ToggleButton>
                            </ToggleButtonGroup>
                </Grid>
            </Grid>
            ...
            >
                <Grid item xs={2} sm={2} md={2} lg={2} >
                    <Typography className={classes.textTiltla}>วันที่รับชำระ</Typography>
                </Grid>
                <Grid item xs={4} sm={4} md={3} lg={3} >
                        <FormikDatePicker
                                autoOk
