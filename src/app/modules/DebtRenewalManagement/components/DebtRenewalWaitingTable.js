...
export default function DebtRenewalWaitingTable(props) {
        ...
        },
        {
            ...
            options: {
              customBodyRenderLite: (dataIndex, rowIndex) => {
                return (
                  <Grid>
                    {(props.moduleName === "DebtStorage" || props.moduleName === "DebtRecovery") && 
                      (
                        ...
                        {props.moduleName === "DebtRenewal"  && 
                      (
                        <Grid >
                                <Typography > {data[dataIndex][1]}  </Typography>
                        </Grid>
                      )
                    }
                  ...
                  <Grid>
                    {
                      ...
                      : 
                      (
                        <Grid style={{ color: data[dataIndex][8] === "รอวิธีรับชำระ" ? '#F61717' : '#18B920'}}>
                        {data[dataIndex][8]}
                        </Grid>
                      )
                    }
              ...
              testData = [
                {
                    ...
                    xxx_payerBranch : "ชลบุรี",
                    xxx_branchCompanyName :"BMW",
                    xxx_workAddress: "1/3 หมู่5 บ่อวิน  ศรีราชา ชลบุรี 20230",
        ...
        testData = [
          {
            ...
            testData.forEach(function(item,i)  {
              ...
              testDataNew.push([
                  ...
                  props.moduleName === "DebtRenewal" || props.moduleName === "DebtStorage" ? item.xxx_productListDetail.length : item.xxx_numOfInstallments  ,//ถ้าเป็นการคืนความคุ้มครอง
                  item.xxx_premiumPrice,
                  item.xxx_paymentType,
                  item.xxx_paymentMethod,
                  item.xxx_lastDatePayment,
                  item.xxx_SLAbalance + " วัน",
