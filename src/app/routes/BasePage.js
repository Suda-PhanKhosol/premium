...
import BillPaymentMthdPage from "../modules/PremiumOperation/pages/BillPaymentMthdPage";
import CardPaymentMthdPage from "../modules/PremiumOperation/pages/CardPaymentMthdPage";
import CustomerPaymentPage from "../modules/PremiumOperation/pages/CustomerPaymentPage";
import PayFailedPage from "../modules/PremiumOperation/pages/PayFailedPage";
    ...
    <React.Fragment>
      <Switch>
        ...
        <ContentRoute
          ...
          component={BillPaymentMthdPage}
        />
         <ContentRoute
          exact
          path="/CardPaymentMethod"
          component={CardPaymentMthdPage}
        />
           <ContentRoute
          exact
